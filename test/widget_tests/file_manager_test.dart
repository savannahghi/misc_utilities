...
void main() {
  ...
  group('FileManagerLogic', () {
    ...
    testWidgets(
      'Should upload file correctly and return the upload ID from the camera',
      (WidgetTester tester) async {
        final List<MethodCall> _methodCalls = <MethodCall>[];
  ...
  group('FileManager', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // expect a bottomsheet to pick a camera or gallery selection
    ...
    testWidgets(
      'should upload file correctly and clear the selection'
      ' after a successful upload with camera selection',
      (WidgetTester tester) async {
        final List<MethodCall> _methodCalls = <MethodCall>[];
    ...
    testWidgets(
      'Image picker should show a CircularProgressIndicator when an upload is '
      'being done with camera selection ',
      (WidgetTester tester) async {
        final List<MethodCall> _methodCalls = <MethodCall>[];
